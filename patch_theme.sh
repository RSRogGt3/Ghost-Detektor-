sed -i '/var isAutoDestroyEnabled/a \    val appThemeColor by viewModel.appThemeColor.collectAsStateWithLifecycle()' app/src/main/java/com/example/ui/screens/FilterSettingsScreen.kt
sed -i '504i \            Card(\
